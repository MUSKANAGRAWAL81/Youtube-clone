...
import './Header.css';
import {    Apps, Notifications, SearchRounded, VideoCallRounded, ViewHeadlineOutlined } from '@mui/icons-material'
    ...
    return (
        <div className='header'>
           ...
           <Link to={`/search/${inputSearch}`}>
               ...
               <SearchRounded className='header_search_button'/>
               </Link>
           </div>
